...
```
Quero estruturar um novo projeto.
...
- Dependências externas: {{O QUE PRECISA DE TERCEIROS OU DE OUTRAS TAREFAS}}

Com base nisso:
1. Crie a pasta do projeto em 03 Projects/{{NOME}}/
2. Crie um README.md com: visão geral, objetivo, resultado esperado, status inicial
3. Quebre o projeto em fases ou milestones principais
4. Para cada fase, liste as 3-5 tarefas mais importantes
5. Identifique o que pode travar o projeto e sugira como mitigar
6. Defina o primeiro passo que posso fazer hoje ou amanhã

Deixe tudo no README.md criado.
```
