...
```
Acabei de sair de uma reunião. Precisa que processe isso para mim.

Dados da reunião:
- Tipo: {{1:1 / equipe / cliente / apresentação / outro}}
- Participantes: {{NOMES}}
- Duração: {{TEMPO}}
...
5. Me diga se identifica algum risco ou ponto que ficou em aberto
```
