...
```
Preciso registrar uma decisão.

A decisão:
- O que foi decidido: {{DESCREVA A DECISÃO EM 1-2 FRASES}}
- Contexto que levou a isso: {{POR QUE ESSA DECISÃO PRECISOU SER TOMADA}}
- Alternativas que considerei: {{OUTRAS OPÇÕES QUE FORAM AVALIADAS}}
- Por que escolhi esta opção: {{RAZÃO PRINCIPAL}}
- Quem foi envolvido: {{SOZINHO / COM QUEM}}
...
6. Critérios para avaliar se foi a decisão certa
7. Data de revisão

Formato: use callout [!important] para a decisão final e [!warning] para os riscos.
```
